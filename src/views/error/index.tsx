    ...
    <Page title="Something went wrong | DigitalEyes">
      <>
        ...
        <div className="max-w-2xl font-light px-4 sm:px-6 lg:px-8 mx-auto ">
          <p>
            Something went wrong and it looks like service is unavailable right now. First things
            first try refreshing the page. If that doesn't work, check out DigitalEyes on Twitter
            for updates on the site.
          </p>

          <a href={DE_DISCORD} target="_blank" className="btn inline-flex mt-10" rel="noreferrer">
