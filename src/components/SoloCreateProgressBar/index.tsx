...
export const SoloCreateProgressBar: React.FC = () => {
  ...
  const [topAmount, setTopAmount] = useState<number | undefined>(0);
  ...
  useEffect(() => {
    const height = document.querySelector(".digitaleyes-appbar")?.clientHeight;
    setTopAmount(height);
  ...
  return (
    <div
      className="sticky progress-bar-container w-full my-14 py-8 z-50"
