...
export const CollectionsView = () => {
  ...
  const [collectionTwitter, setCollectionTwitter] = useState<string | undefined>("")
  const [collectionDiscord, setCollectionDiscord] = useState<string | undefined>("")
  const [collectionBanner, setCollectionBanner] = useState<string | undefined>(" ")
  const [collectionIsDerivative, setCollectionisDerivative] = useState<boolean>(false)
          ...
          >
            ...
            <div className="pt-16 sm:pt-10 z-10">
              ...
              <div className="flex items-center justify-center gap-8 w-full mt-4 mb-8">
                {collectionDiscord !="" && (
                  <ProfileLink
                    isClipboard={!collectionDiscord?.includes("https://discord.gg/")}
                ...
                {collectionTwitter !="" && (
                  <ProfileLink
                    isClipboard={!collectionTwitter?.includes("https://twitter.com/")}
              ...
              {!currentCollection?.verifeyed && <>
               ...
               {collectionIsDerivative && <>
                ...
                <div className="bg-black text-white rounded-md p-2 max-w-xs ">
                <p className="text-xs">These collectons/NFTs are derivatives of existing art/NFT collections, and thus represent a higher risk for buyers. Please buy at your own discretion. Please check our FAQ for more details.   </p>
                </div>
                </Tooltip></>}
              </div>
            </div>
